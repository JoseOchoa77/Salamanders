...
<body>
    ...
    for($i=0; $i<sizeof($parkingPermits); $i++)
      {
        if($parkingPermits[$permitNumber]);
		...
		print ("<p>The license plate number for the parking space $licenseNumber is $parkingPermits[$permitNumber]</p>");
	?>
</body>
</html>
